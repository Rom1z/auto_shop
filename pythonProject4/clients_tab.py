...
def open_work_info_dialog(tree, connection):
    ...
    if selected_item:
        ...
        ctk.CTkLabel(dialog, text="Дата приема:").grid(row=0, column=0, padx=5, pady=5)
        ctk.CTkEntry(dialog, textvariable=date_start_var).grid(row=0, column=1, padx=5, pady=5)

        ctk.CTkLabel(dialog, text="Дата завершения:").grid(row=1, column=0, padx=5, pady=5)
        ctk.CTkEntry(dialog, textvariable=date_end_var).grid(row=1, column=1, padx=5, pady=5)

        ctk.CTkLabel(dialog, text="Этап работы:").grid(row=2, column=0, padx=5, pady=5)
        ctk.CTkEntry(dialog, textvariable=stage_var).grid(row=2, column=1, padx=5, pady=5)
        ...
        ctk.CTkButton(dialog, text="Готово", command=update_data, fg_color="green").grid(row=3, columnspan=2, padx=5, pady=5)
